...
const steps = ["Personal Info", "Family Details", "Address", "Documents", "Review"];
      ...
      <SurfaceCard className="p-8">
        <div className="flex items-center justify-between mb-10">
          {steps.map((step, i) => (
            <div key={i} className="flex flex-col items-center flex-1">
              ...
              <span className={`text-xs font-medium text-center ${i === 1 ? "text-primary" : "text-muted-foreground"}`}>
                {step}
              </span>
            </div>
          ))}
        ...
        <div className="space-y-6">
          <div>
            ...
            <Input placeholder="As per Aadhaar" className="h-12 text-base" />
          </div>
          <div>
          ...
          <div>
            ...
            <Input placeholder="Leave blank if not applicable" className="h-12 text-base" />
          </div>
        </div>
