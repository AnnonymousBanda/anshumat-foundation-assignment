...
const items = [
    {
        icon: IdCard,
        label: 'Aadhaar Card',
        desc: 'Your 12-digit Aadhaar number linked to your mobile',
    },
    {
        icon: FileText,
        label: 'Address Proof',
        desc: 'Utility bill, bank statement, or rent agreement',
    },
    {
        icon: Wifi,
        label: 'Stable Internet',
        desc: 'For uploading documents and completing payment',
    },
]
...
export default function OnboardingPage() {
    ...
    const handleFormCreation = async (
        ...
        try {
            const res = await axios.post('/api/form/new-form')
            ...
            notify.info('Redirecting you to the application form...')
            router.push(`/form?applicationId=${res.data.application_id}&step=1`)
        } catch (error: unknown) {
    ...
    return (
        <PageShell
            ...
            contentClassName="max-w-2xl py-16 animate-fade-in"
        >
            <h1 className="mb-2">Before we start...</h1>
            <p className="text-muted-foreground mb-10">
                Please keep these items handy for a smooth application process.
            </p>
